...
- v0.3 - plot/ 繪圖
  - 請用 plotly.js 套件，不需要和 matplotlib 一樣，但 API 盡量做得和 math4py/plot 一樣
  - 請寫一個類似 /Users/Shared/ccc/project/math4py/examples/statistics/clt.py 的範例，可以示範中央極限定理。
- v0.4 - linear_algebra/ 線性代數
  - 請參考 https://github.com/sloisel/numeric/tree/master/src (可以移植複製)
